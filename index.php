...
<div id="wrapper">
	<div id="header">
    <h1><a href="index.php"><MTC ONLINE TICKET BOOKINGS/></a></h1>
        <ul id="mainnav">
    ...
    <div id="content">
    	<div id="rotator">
              <ul>
                    <img src="202108302016514930_Tamil-Nadu-government-allows-free-bus-travel-for-school-and_SECVPF.webp" width="861" height="379"  alt="" /></li>
	...
	<div id="footer">
	<h4>+63(2)3525393 &bull; <a href="contact-us.php">KOYAMBEDU BUS STAND, CHENNAI </a></h4>
	<p>Hours of Operation&nbsp;&nbsp;&bull;&nbsp;&nbsp;Mon - Sun: 4:00 am - 12:00 am</p>
